...
- `SKILL.md` orchestrates the 10-step workflow (scope, brainstorm personas, align, dispatch, harden rubrics, write reviews, debate findings, clean up team, synthesize, act)
