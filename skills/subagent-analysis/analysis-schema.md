...
their domain. The rubric is generated by the teammate during Step 5 (Rubric
Hardening) — the teammate drafts criteria from domain expertise, refines them
after reading the artifact, and hardens them through cross-persona debate.
Evaluation logic:
...
even if no challenges were received (write "No challenges received").
